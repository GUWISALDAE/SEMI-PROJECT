	...
	<%@ include file="../common/헤더.jsp" %>
	 <div class="d-flex flex-column flex-shrink-0 p-3  side-bar" >
      <ul class="nav nav-pills flex-column mb-auto" style="margin-top:110%;">
        ...
        <br><br>
        <li>
          <a href="<%= contextPath %>/views/notice/문의하기.jsp" class="nav-link" style="color:blue; border-bottom: 1px solid black; border-radius: 0px;">
            <font style="vertical-align: inherit; font-size: 30px;"><font style="vertical-align: inherit;">
            문의하기
          </font></font></a>
        </li>
          ...
          <tr>
            <td>
              <select style="width: 400px;">
                ...
                <option  value="1"> 프로젝트를 개설한 메이커 입니다. </option>
                <option value="2"> 프로젝트에 참여한 서포터 입니다. </option>
              </select>
          </td>
          </tr>
          <tr>
